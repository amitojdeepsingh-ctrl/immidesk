...
const FIELD_MAP: Record<string, string[]> = {
  givenName: ["firstName", "givenNames", "givenName", "first_name", "given_name", "fname"],
  lastName: ["lastName", "surname", "familyName", "family_name", "last_name", "lname"],
  middleName: ["middleNames", "middleName", "middle_name"],
  fullName: ["fullName", "name"],
  dateOfBirth: ["dateOfBirth", "dob", "birthDate", "birth_date", "date_of_birth"],
  placeOfBirth: ["birthCity", "cityOfBirth", "city", "birthPlace", "birth_place", "place_of_birth"],
  countryOfBirth: ["birthCountry", "countryOfBirth", "country_of_birth"],
  citizenship: ["nationality", "birthCountry", "citizenship", "country", "citizenOf"],
  height: ["height"],
  eyeColor: ["eyeColour", "eyeColor", "eyes"],
  ...
  passportIssueDate: ["passportIssueDate", "passport_issue_date", "dateOfIssue"],
  passportExpiryDate: ["passportExpiryDate", "passport_expiry_date", "dateOfExpiry"],
  currentAddress: ["currentAddress", "addressLine1", "address", "street", "address_line1"],
  email: ["email", "emailAddress", "email_address"],
  phone: ["cellPhone", "phone", "telephone", "phoneNumber", "phone_number", "mobile", "contactNo", "homePhone"],
  occupation: ["occupation", "jobTitle", "currentOccupation"],
  fatherName: ["fatherFamilyName", "fatherName"],
  motherName: ["motherMaidenName", "motherFamilyName", "motherName"],
  nativeLanguage: ["nativeLanguage", "motherTongue"],
  signature: ["firstName", "givenNames", "givenName"],
  dateSigned: [],
};
